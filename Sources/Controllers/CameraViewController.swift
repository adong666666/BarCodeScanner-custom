...
open class CameraViewController: UIViewController {
  ...
  /// Animated focus view.
  open private(set) lazy var focusView: UIView = self.makeFocusView()
  ...
  private func setupSessionInput(for position: AVCaptureDevice.Position) {
    ...
    do {
      ...
      flashButton.isHidden = true//position == .front
    } catch {
...
private extension CameraViewController {
  ...
  func setupFocusViewConstraints() {
    ...
    animatedFocusViewConstraints = [
      focusView.widthAnchor.constraint(equalToConstant: 279),
